...
################################################################################
## Form generated from reading UI file 'ENCOSOFTDaUegk.ui'
##
...
"background-color: rgb(255, 255, 255);")
        ...
        icon = QIcon()
        icon.addFile(u"images/Recurso 3.png", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.pushButton_5.setStyleSheet(u"border-color: rgb(0, 0, 0);")
